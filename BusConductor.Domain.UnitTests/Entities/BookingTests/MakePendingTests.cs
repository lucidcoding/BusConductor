...
namespace BusConductor.Domain.UnitTests.Entities.BookingTests
{
    ...
    public class MakePendingTests
    {
        ...
        public void SetUp()
        {
            ...
            _parameterSet.Bus.PricingPeriods.Add(new PricingPeriod());
            _parameterSet.Bus.PricingPeriods[0].StartMonth = 1;
            _parameterSet.Bus.PricingPeriods[0].StartDay = 1;
            _parameterSet.Bus.PricingPeriods[0].EndMonth = 12;
            _parameterSet.Bus.PricingPeriods[0].EndDay = 31;
            _parameterSet.Bus.PricingPeriods[0].FridayToFridayRate = 600;
